...
void powermeter_setup_tile_setup( uint32_t tile_num ) {
    ...
    lv_obj_align_to( header, powermeter_setup_tile, LV_ALIGN_IN_TOP_LEFT, THEME_ICON_PADDING, THEME_ICON_PADDING );

    lv_obj_t *header_2 = wf_add_settings_header( powermeter_setup_tile_2, "powermeter setup" );
    lv_obj_align_to( header_2, powermeter_setup_tile_2, LV_ALIGN_IN_TOP_LEFT, THEME_ICON_PADDING, THEME_ICON_PADDING );

    lv_obj_t *setup_page_2 = wf_add_down_button( powermeter_setup_tile, powermeter_setup_page_2_event_cb );
    lv_obj_align_to( setup_page_2, powermeter_setup_tile, LV_ALIGN_IN_TOP_RIGHT, -THEME_ICON_PADDING, THEME_ICON_PADDING );
    ...
    lv_obj_add_style( powermeter_server_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( powermeter_server_cont, header, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 0 );
    lv_obj_t *powermeter_server_label = lv_label_create( powermeter_server_cont, NULL);
    lv_obj_add_style( powermeter_server_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( powermeter_server_label, "server");
    lv_obj_align_to( powermeter_server_label, powermeter_server_cont, LV_ALIGN_IN_LEFT_MID, 0, 0 );
    ...
    lv_obj_align_to( powermeter_server_textfield, powermeter_server_cont, LV_ALIGN_IN_RIGHT_MID, -5, 0 );
    ...
    lv_obj_add_style( powermeter_port_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( powermeter_port_cont, powermeter_server_cont, LV_ALIGN_OUT_BOTTOM_MID, 0,  0 );
    lv_obj_t *powermeter_port_label = lv_label_create( powermeter_port_cont, NULL);
    lv_obj_add_style( powermeter_port_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( powermeter_port_label, "port");
    lv_obj_align_to( powermeter_port_label, powermeter_port_cont, LV_ALIGN_IN_LEFT_MID, 0, 0 );
    ...
    lv_obj_align_to( powermeter_port_textfield, powermeter_port_cont, LV_ALIGN_IN_RIGHT_MID, -5, 0 );
    ...
    lv_obj_add_style( powermeter_user_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( powermeter_user_cont, powermeter_port_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 0 );
    lv_obj_t *powermeter_user_label = lv_label_create( powermeter_user_cont, NULL);
    lv_obj_add_style( powermeter_user_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( powermeter_user_label, "user");
    lv_obj_align_to( powermeter_user_label, powermeter_user_cont, LV_ALIGN_IN_LEFT_MID, 0, 0 );
    ...
    lv_obj_align_to( powermeter_user_textfield, powermeter_user_cont, LV_ALIGN_IN_RIGHT_MID, -5, 0 );
    ...
    lv_obj_add_style( powermeter_password_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( powermeter_password_cont, powermeter_user_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 0 );
    lv_obj_t *powermeter_password_label = lv_label_create( powermeter_password_cont, NULL);
    lv_obj_add_style( powermeter_password_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( powermeter_password_label, "pass");
    lv_obj_align_to( powermeter_password_label, powermeter_password_cont, LV_ALIGN_IN_LEFT_MID, 0, 0 );
    ...
    lv_obj_align_to( powermeter_password_textfield, powermeter_password_cont, LV_ALIGN_IN_RIGHT_MID, -5, 0 );
    ...
    lv_obj_add_style( powermeter_topic_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( powermeter_topic_cont, powermeter_password_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 0 );
    lv_obj_t *powermeter_topic_label = lv_label_create( powermeter_topic_cont, NULL);
    lv_obj_add_style( powermeter_topic_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( powermeter_topic_label, "topic");
    lv_obj_align_to( powermeter_topic_label, powermeter_topic_cont, LV_ALIGN_IN_LEFT_MID, 0, 0 );
    ...
    lv_obj_align_to( powermeter_topic_textfield, powermeter_topic_cont, LV_ALIGN_IN_RIGHT_MID, -5, 0 );
    ...
    lv_obj_add_style( powermeter_autoconnect_onoff_cont, LV_PART_MAIN, SETUP_STYLE );
    lv_obj_align_to( powermeter_autoconnect_onoff_cont, header_2, LV_ALIGN_OUT_BOTTOM_LEFT, -THEME_ICON_PADDING, THEME_ICON_PADDING );
    powermeter_autoconnect_onoff = wf_add_switch( powermeter_autoconnect_onoff_cont, false);
    lv_obj_align_to( powermeter_autoconnect_onoff, powermeter_autoconnect_onoff_cont, LV_ALIGN_IN_RIGHT_MID, -5, 0);
    ...
    lv_obj_add_style( powermeter_autoconnect_label, LV_PART_MAIN, SETUP_STYLE );
    lv_label_set_text( powermeter_autoconnect_label, "autoconnect");
    lv_obj_align_to( powermeter_autoconnect_label, powermeter_autoconnect_onoff_cont, LV_ALIGN_IN_LEFT_MID, 5, 0);
    ...
    lv_obj_add_style( powermeter_widget_onoff_cont, LV_PART_MAIN, SETUP_STYLE );
    lv_obj_align_to( powermeter_widget_onoff_cont, powermeter_autoconnect_onoff_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_ICON_PADDING );
    powermeter_widget_onoff = wf_add_switch( powermeter_widget_onoff_cont, false);
    lv_obj_align_to( powermeter_widget_onoff, powermeter_widget_onoff_cont, LV_ALIGN_IN_RIGHT_MID, -5, 0);
    ...
    lv_obj_add_style( powermeter_widget_onoff_label, LV_PART_MAIN, SETUP_STYLE );
    lv_label_set_text( powermeter_widget_onoff_label, "mainbar widget");
    lv_obj_align_to( powermeter_widget_onoff_label, powermeter_widget_onoff_cont, LV_ALIGN_IN_LEFT_MID, 5, 0);
