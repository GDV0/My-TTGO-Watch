...
void mail_app_setup( uint32_t tile_num ) {
    ...
    lv_obj_align_to( header, mail_app_setup_tile, LV_ALIGN_IN_TOP_LEFT, THEME_PADDING, THEME_PADDING );

    lv_obj_t *mail_server_cont = lv_obj_create( mail_app_setup_tile);
    lv_obj_set_size( mail_server_cont, lv_disp_get_hor_res( NULL ) , THEME_CONT_HEIGHT );
    lv_obj_add_style( mail_server_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( mail_server_cont, header, LV_ALIGN_OUT_BOTTOM_LEFT, -THEME_PADDING, 0 );
    lv_obj_t *mail_server_label = lv_label_create( mail_server_cont);
    lv_obj_add_style( mail_server_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( mail_server_label, "imap server");
    lv_obj_align_to( mail_server_label, mail_server_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    ...
    lv_obj_align_to( mail_server_textfield, mail_server_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    lv_obj_set_event_cb( mail_server_textfield, mail_setup_textarea_event_cb );

    lv_obj_t *mail_port_cont = lv_obj_create( mail_app_setup_tile );
    lv_obj_set_size( mail_port_cont, lv_disp_get_hor_res( NULL ) , THEME_CONT_HEIGHT );
    lv_obj_add_style( mail_port_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( mail_port_cont, mail_server_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 0 );
    lv_obj_t *mail_port_label = lv_label_create( mail_port_cont);
    lv_obj_add_style( mail_port_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( mail_port_label, "imap port");
    lv_obj_align_to( mail_port_label, mail_port_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    mail_port_textfield = lv_textarea_create( mail_port_cont);
    ...
    lv_obj_align_to( mail_port_textfield, mail_port_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    lv_obj_set_event_cb( mail_port_textfield, mail_setup_num_textarea_event_cb );

    lv_obj_t *mail_folder_cont = lv_obj_create( mail_app_setup_tile );
    lv_obj_set_size( mail_folder_cont, lv_disp_get_hor_res( NULL ) , THEME_CONT_HEIGHT );
    lv_obj_add_style( mail_folder_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( mail_folder_cont, mail_port_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 0 );
    lv_obj_t *mail_folder_label = lv_label_create( mail_folder_cont);
    lv_obj_add_style( mail_folder_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( mail_folder_label, "inbox folder");
    lv_obj_align_to( mail_folder_label, mail_folder_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    mail_folder_textfield = lv_textarea_create( mail_folder_cont);
    ...
    lv_obj_align_to( mail_folder_textfield, mail_folder_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    lv_obj_set_event_cb( mail_folder_textfield, mail_setup_textarea_event_cb );

    lv_obj_t *mail_user_cont = lv_obj_create( mail_app_setup_tile);
    lv_obj_set_size( mail_user_cont, lv_disp_get_hor_res( NULL ) , THEME_CONT_HEIGHT );
    lv_obj_add_style( mail_user_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( mail_user_cont, mail_folder_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 0 );
    lv_obj_t *mail_user_label = lv_label_create( mail_user_cont;
    lv_obj_add_style( mail_user_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( mail_user_label, "user name");
    lv_obj_align_to( mail_user_label, mail_user_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    mail_user_textfield = lv_textarea_create( mail_user_cont);
    ...
    lv_obj_align_to( mail_user_textfield, mail_user_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    lv_obj_set_event_cb( mail_user_textfield, mail_setup_textarea_event_cb );

    lv_obj_t *mail_password_cont = lv_obj_create( mail_app_setup_tile );
    lv_obj_set_size( mail_password_cont, lv_disp_get_hor_res( NULL ) , THEME_CONT_HEIGHT );
    lv_obj_add_style( mail_password_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( mail_password_cont, mail_user_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 0 );
    lv_obj_t *mail_password_label = lv_label_create( mail_password_cont);
    lv_obj_add_style( mail_password_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( mail_password_label, "imap server");
    lv_obj_align_to( mail_password_label, mail_password_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    mail_password_textfield = lv_textarea_create( mail_password_cont);
    ...
    lv_obj_align_to( mail_password_textfield, mail_password_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
