...
void kodi_remote_app_setup_setup( uint32_t tile_num ) {
    ...
    lv_obj_align_to( header, kodi_remote_app_setup_tile, LV_ALIGN_IN_TOP_LEFT, 10, 10 );

    // config fields    
    lv_obj_t *kodi_remote_server_cont = lv_obj_create( kodi_remote_app_setup_tile );
    lv_obj_set_size( kodi_remote_server_cont, lv_disp_get_hor_res( NULL ) , 37);
    lv_obj_add_style( kodi_remote_server_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( kodi_remote_server_cont, header, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_ICON_PADDING );
    lv_obj_t *kodi_remote_server_label = lv_label_create( kodi_remote_server_cont);
    lv_obj_add_style( kodi_remote_server_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( kodi_remote_server_label, "host");
    lv_obj_align_to( kodi_remote_server_label, kodi_remote_server_cont, LV_ALIGN_IN_LEFT_MID, THEME_ICON_PADDING, 0 );
    kodi_remote_host_textfield = lv_textarea_create( kodi_remote_server_cont);
    ...
    lv_obj_align_to( kodi_remote_host_textfield, kodi_remote_server_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_ICON_PADDING, 0 );
    lv_obj_set_event_cb( kodi_remote_host_textfield, kodi_remote_textarea_event_cb );

    lv_obj_t *kodi_remote_port_cont = lv_obj_create( kodi_remote_app_setup_tile);
    lv_obj_set_size( kodi_remote_port_cont, lv_disp_get_hor_res( NULL ) , 37);
    lv_obj_add_style( kodi_remote_port_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( kodi_remote_port_cont, kodi_remote_server_cont, LV_ALIGN_OUT_BOTTOM_MID, 0,  THEME_ICON_PADDING );
    lv_obj_t *kodi_remote_port_label = lv_label_create( kodi_remote_port_cont);
    lv_obj_add_style( kodi_remote_port_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( kodi_remote_port_label, "port");
    lv_obj_align_to( kodi_remote_port_label, kodi_remote_port_cont, LV_ALIGN_IN_LEFT_MID, THEME_ICON_PADDING, 0 );
    kodi_remote_port_textfield = lv_textarea_create( kodi_remote_port_cont);
    char buf[10];
    ...
    lv_obj_align_to( kodi_remote_port_textfield, kodi_remote_port_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_ICON_PADDING, 0 );
    lv_obj_set_event_cb( kodi_remote_port_textfield, kodi_remote_num_textarea_event_cb );

    lv_obj_t *kodi_remote_user_cont = lv_obj_create( kodi_remote_app_setup_tile );
    lv_obj_set_size( kodi_remote_user_cont, lv_disp_get_hor_res( NULL ) , 37);
    lv_obj_add_style( kodi_remote_user_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( kodi_remote_user_cont, kodi_remote_port_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_ICON_PADDING );
    lv_obj_t *kodi_remote_user_label = lv_label_create( kodi_remote_user_cont;
    lv_obj_add_style( kodi_remote_user_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( kodi_remote_user_label, "user");
    lv_obj_align_to( kodi_remote_user_label, kodi_remote_user_cont, LV_ALIGN_IN_LEFT_MID, THEME_ICON_PADDING, 0 );
    kodi_remote_user_textfield = lv_textarea_create( kodi_remote_user_cont;
    ...
    lv_obj_align_to( kodi_remote_user_textfield, kodi_remote_user_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_ICON_PADDING, 0 );
    lv_obj_set_event_cb( kodi_remote_user_textfield, kodi_remote_textarea_event_cb );

    lv_obj_t *kodi_remote_password_cont = lv_obj_create( kodi_remote_app_setup_tile );
    lv_obj_set_size( kodi_remote_password_cont, lv_disp_get_hor_res( NULL ) , 37);
    lv_obj_add_style( kodi_remote_password_cont, LV_PART_MAIN, SETUP_STYLE  );
    lv_obj_align_to( kodi_remote_password_cont, kodi_remote_user_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_ICON_PADDING );
    lv_obj_t *kodi_remote_password_label = lv_label_create( kodi_remote_password_cont);
    lv_obj_add_style( kodi_remote_password_label, LV_PART_MAIN, SETUP_STYLE  );
    lv_label_set_text( kodi_remote_password_label, "pass");
    lv_obj_align_to( kodi_remote_password_label, kodi_remote_password_cont, LV_ALIGN_IN_LEFT_MID, THEME_ICON_PADDING, 0 );
    kodi_remote_pass_textfield = lv_textarea_create( kodi_remote_password_cont);
    ...
    lv_obj_align_to( kodi_remote_pass_textfield, kodi_remote_password_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_ICON_PADDING, 0 );
