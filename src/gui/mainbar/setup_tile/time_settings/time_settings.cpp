...
void time_settings_tile_setup( void ) {
    ...
    lv_obj_align_to( clock_fmt_cont, wifisync_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 8 );
    ...
    lv_obj_align_to( region_cont, clock_fmt_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 8 );
    ...
    lv_obj_align_to( location_cont, region_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 8 );
