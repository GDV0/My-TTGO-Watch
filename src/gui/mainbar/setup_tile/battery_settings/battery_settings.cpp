...
void battery_settings_tile_setup( void ) {
    ...
    lv_obj_align_to( battery_setup_label_cont, battery_silence_wakeup_switch_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 2 );
    ...
    lv_obj_align_to( battery_percent_switch_cont, battery_setup_label_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 2 );
    ...
    lv_obj_align_to( battery_experimental_switch_cont, battery_percent_switch_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 2 );
    ...
    lv_obj_align_to( battery_high_voltage_switch_cont, battery_experimental_switch_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 2 );
