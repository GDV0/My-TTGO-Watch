...
void battery_view_tile_setup( uint32_t tile_num ) {
    ...
    lv_obj_align_to( battery_design_cont, battery_view_tile, LV_ALIGN_IN_TOP_RIGHT, 0, 75 );
    ...
    lv_obj_align_to( battery_design_cap_label, battery_design_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    ...
    lv_obj_align_to( battery_view_design_cap, battery_design_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    ...
    lv_obj_align_to( battery_current_cap_label, battery_current_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    ...
    lv_obj_align_to( battery_view_current_cap, battery_current_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    ...
    lv_obj_align_to( battery_voltage_label, battery_voltage_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    ...
    lv_obj_align_to( battery_view_voltage, battery_voltage_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    ...
    lv_obj_align_to( battery_charge_label, battery_charge_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    ...
    lv_obj_align_to( charge_view_current, battery_charge_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    ...
    lv_obj_align_to( battery_discharge_label, battery_discharge_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    ...
    lv_obj_align_to( discharge_view_current, battery_discharge_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
    ...
    lv_obj_align_to( vbus_voltage_label, vbus_voltage_cont, LV_ALIGN_IN_LEFT_MID, THEME_PADDING, 0 );
    ...
    lv_obj_align_to( vbus_view_voltage, vbus_voltage_cont, LV_ALIGN_IN_RIGHT_MID, -THEME_PADDING, 0 );
...
static void battery_view_update_task( lv_task_t *task ) {
    ...
    lv_obj_align_to( battery_view_current_cap, lv_obj_get_parent( battery_view_current_cap ), LV_ALIGN_IN_RIGHT_MID, -5, 0 );

    snprintf( temp, sizeof( temp ), "%dmAh", pmu_get_designed_battery_cap() );
    lv_label_set_text( battery_view_design_cap, temp );
    lv_obj_align_to( battery_view_design_cap, lv_obj_get_parent( battery_view_design_cap ), LV_ALIGN_IN_RIGHT_MID, -5, 0 );

    snprintf( temp, sizeof( temp ), "%0.2fV", pmu_get_battery_voltage() / 1000 );
    lv_label_set_text( battery_view_voltage, temp );
    lv_obj_align_to( battery_view_voltage, lv_obj_get_parent( battery_view_voltage ), LV_ALIGN_IN_RIGHT_MID, -5, 0 );

    snprintf( temp, sizeof( temp ), "%0.1fmA", pmu_get_battery_charge_current() );
    lv_label_set_text( charge_view_current, temp );
    lv_obj_align_to( charge_view_current, lv_obj_get_parent( charge_view_current ), LV_ALIGN_IN_RIGHT_MID, -5, 0 );

    snprintf( temp, sizeof( temp ), "%0.1fmA", pmu_get_battery_discharge_current() );
    lv_label_set_text( discharge_view_current, temp );
    lv_obj_align_to( discharge_view_current, lv_obj_get_parent( discharge_view_current ), LV_ALIGN_IN_RIGHT_MID, -5, 0 );

    snprintf( temp, sizeof( temp ), "%0.2fV", pmu_get_vbus_voltage() / 1000 );
    lv_label_set_text( vbus_view_voltage, temp );
    lv_obj_align_to( vbus_view_voltage, lv_obj_get_parent( vbus_view_voltage ), LV_ALIGN_IN_RIGHT_MID, -5, 0 );
}
