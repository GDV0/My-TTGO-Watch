...
void bluetooth_settings_tile_setup( void ) {
    lv_obj_t *header_2 = NULL;
        ...
        lv_obj_add_style( bluetooth_settings_tile_1, LV_PART_MAIN, ws_get_setup_tile_style() );
        lv_obj_add_style( bluetooth_settings_tile_2, LV_PART_MAIN, ws_get_setup_tile_style() );
    #else
    ...
    lv_obj_align_to( header, bluetooth_settings_tile_1, LV_ALIGN_IN_TOP_LEFT, THEME_PADDING, STATUSBAR_HEIGHT + THEME_PADDING );
    
    if ( bluetooth_settings_tile_2 ) {
        header_2 = wf_add_settings_header( bluetooth_settings_tile_2, "bluetooth settings" );
        lv_obj_align_to( header_2, bluetooth_settings_tile_2, LV_ALIGN_IN_TOP_LEFT, THEME_PADDING, STATUSBAR_HEIGHT + THEME_PADDING );
        ...
        lv_obj_align_to( up_btn_1, bluetooth_settings_tile_2, LV_ALIGN_IN_TOP_RIGHT, -THEME_PADDING, STATUSBAR_HEIGHT + THEME_PADDING );
        ...
        lv_obj_align_to( down_btn_1, bluetooth_settings_tile_1, LV_ALIGN_IN_TOP_RIGHT, -THEME_PADDING, STATUSBAR_HEIGHT + THEME_PADDING );
    }
    ...
    lv_obj_align_to( bluetooth_enable_cont, header, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    ...
    lv_obj_align_to( bluetooth_advertising_cont, bluetooth_enable_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    ...
    lv_obj_align_to( bluetooth_standby_cont, bluetooth_advertising_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    ...
    lv_obj_align_to( bluetooth_stayon_cont, bluetooth_standby_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    ...
    if ( bluetooth_settings_tile_2 ) {
        ...
        lv_obj_align_to( txpower_cont, header_2, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    }
    else {
        ...
        lv_obj_align_to( txpower_cont, bluetooth_stayon_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    }
