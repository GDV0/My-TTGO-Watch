...
void notify_settings_tile_setup( void ) {
    ...
    lv_obj_align_to( notify_show_notification_cont, notify_wakeup_on_notification_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    ...
    lv_obj_align_to( notify_vibe_notification_cont, notify_show_notification_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    ...
    lv_obj_align_to( notify_sound_notification_cont, notify_vibe_notification_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
    ...
    lv_obj_align_to( notify_media_notification_cont, notify_sound_notification_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, THEME_PADDING );
}
